    ...
    return (
        ...
        <ScrollView contentContainerStyle={[styles.container, { backgroundColor: Colors[colorScheme ?? "light"].background, paddingBottom: tabBarHeight + 20 }]}>
            <View style={styles.header}>
                ...
                <Text style={[styles.title, {color: Colors[colorScheme ?? "light"].text}]}>Preferences</Text>
                <View style={{width: 40}} />
            </View>

            <View style={styles.content}>
                <Text style={[styles.sectionTitle, {color: Colors[colorScheme ?? "light"].text}]}>Settings</Text>
