    ...
    return (
        ...
        <ScrollView contentContainerStyle={[styles.container, { backgroundColor: Colors[colorScheme ?? "light"].background, paddingBottom: tabBarHeight + 20 }]}>
            <View style={styles.header}>
                ...
                <Text style={[styles.title, {color: Colors[colorScheme ?? "light"].text}]}>Edit Photos</Text>
                <View style={{width: 40}} />
            </View>

            <View style={styles.content}>
                <Text style={[styles.sectionTitle, {color: Colors[colorScheme ?? "light"].text}]}>Your Photos</Text>
                <Text style={[styles.description, {color: Colors[colorScheme ?? "light"].textSecondary}]}>
                    Manage and update your profile photos here.
                </Text>
            </View>
        </ScrollView>
        </SafeAreaView>
